...
namespace BlogApp.API.Migrations
{
    ...
    [Migration("20251218062940_addedcommentTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogApp.API.Data.Entities.ApplicationRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlogApp.API.Data.Entities.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlogApp.API.Data.Entities.Blog", b =>
                {
                    ...
                    b.HasOne("BlogApp.API.Data.Entities.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("BlogApp.API.Data.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("BlogApp.API.Data.Entities.Comment", "ParentComment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("BlogApp.API.Data.Entities.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("BlogApp.API.Data.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
